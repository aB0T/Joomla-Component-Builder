...
<ul>
	<li><?php echo Text::_('COM_COMPONENTBUILDER_APPLIED_MARKET_MULTIPLIER_BASED_ON_PROJECT_SIZE_AND_DEMAND'); ?>:
		<b><?php echo '#'.'##MARKET_MULTIPLIER_CHOSEN##'.'#'; ?></b>
	</li>
...
<p><?php echo Text::_('COM_COMPONENTBUILDER_BELOW_ARE_SUGGESTED_PRICING_STRATEGIES_BASED_ON_MARKET_STANDARDS_AND_SUSTAINABILITY_PRINCIPLES'); ?><br>
<?php echo Text::sprintf('COM_COMPONENTBUILDER_SUBSCRIPTION_MODEL_IS_BASED_ON_AN_EXPECTED_SUBSCRIPTION_OF_BSB_PERMONTH', '#'.'##SUBSCRIPTION_PER_MONTH##'.'#'); ?></p>
...
<p>
	...
	<small>
		...
		<?php echo Text::_('COM_COMPONENTBUILDER_ALL_CALCULATION_PARAMETERS_INCLUDING_BHOURLY_RATEB_BLICENSE_COSTB_BPROFIT_MARGINB_AND_BMARKET_DEMAND_THRESHOLDSB_CAN_BE_CUSTOMIZED_IN_THE_COMPONENT_BOPTIONSB_AREA_UNDER_THE_TAB_BVALUATION_DEVELOPMENT_MODELB'); ?>
	</small>
</p>
