 ...
 * @since  1.6
 */
class Admin_custom_tabsModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/admin_custom_tabs.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/admin_custom_tabs.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'admin_custom_tabs', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('admin_custom_tabs.delete', 'com_componentbuilder.admin_custom_tabs.' . (int) $record->id);
	}
