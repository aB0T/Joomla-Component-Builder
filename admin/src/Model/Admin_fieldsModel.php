 ...
 * @since  1.6
 */
class Admin_fieldsModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/admin_fields.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/admin_fields.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'admin_fields', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('admin_fields.delete', 'com_componentbuilder.admin_fields.' . (int) $record->id);
	}
