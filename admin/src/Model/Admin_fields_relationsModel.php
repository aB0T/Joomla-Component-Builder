 ...
 * @since  1.6
 */
class Admin_fields_relationsModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/admin_fields_relations.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/admin_fields_relations.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'admin_fields_relations', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('admin_fields_relations.delete', 'com_componentbuilder.admin_fields_relations.' . (int) $record->id);
	}
