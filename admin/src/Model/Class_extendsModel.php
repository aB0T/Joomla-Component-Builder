 ...
 * @since  1.6
 */
class Class_extendsModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/class_extends.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/class_extends.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'class_extends', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('class_extends.delete', 'com_componentbuilder.class_extends.' . (int) $record->id);
	}
