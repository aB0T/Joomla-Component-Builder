 ...
 * @since  1.6
 */
class Class_methodModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/class_method.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/class_method.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'class_method', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('class_method.delete', 'com_componentbuilder.class_method.' . (int) $record->id);
	}
