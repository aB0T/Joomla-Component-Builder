 ...
 * @since  1.6
 */
class Class_propertyModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/class_property.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/class_property.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'class_property', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('class_property.delete', 'com_componentbuilder.class_property.' . (int) $record->id);
	}
