 ...
 * @since  1.6
 */
class Component_configModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_config.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_config.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_config', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_config.delete', 'com_componentbuilder.component_config.' . (int) $record->id);
	}
