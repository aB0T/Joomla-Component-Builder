 ...
 * @since  1.6
 */
class Component_custom_admin_menusModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_custom_admin_menus.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_custom_admin_menus.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_custom_admin_menus', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_custom_admin_menus.delete', 'com_componentbuilder.component_custom_admin_menus.' . (int) $record->id);
	}
