 ...
 * @since  1.6
 */
class Component_files_foldersModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_files_folders.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_files_folders.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_files_folders', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_files_folders.delete', 'com_componentbuilder.component_files_folders.' . (int) $record->id);
	}
