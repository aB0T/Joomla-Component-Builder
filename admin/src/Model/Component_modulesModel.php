 ...
 * @since  1.6
 */
class Component_modulesModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_modules.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_modules.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_modules', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_modules.delete', 'com_componentbuilder.component_modules.' . (int) $record->id);
	}
