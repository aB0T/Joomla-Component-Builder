 ...
 * @since  1.6
 */
class Component_mysql_tweaksModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_mysql_tweaks.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_mysql_tweaks.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_mysql_tweaks', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_mysql_tweaks.delete', 'com_componentbuilder.component_mysql_tweaks.' . (int) $record->id);
	}
