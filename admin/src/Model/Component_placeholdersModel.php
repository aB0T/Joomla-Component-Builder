 ...
 * @since  1.6
 */
class Component_placeholdersModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_placeholders.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_placeholders.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_placeholders', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_placeholders.delete', 'com_componentbuilder.component_placeholders.' . (int) $record->id);
	}
