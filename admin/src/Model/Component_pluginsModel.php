 ...
 * @since  1.6
 */
class Component_pluginsModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/component_plugins.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/component_plugins.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'component_plugins', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('component_plugins.delete', 'com_componentbuilder.component_plugins.' . (int) $record->id);
	}
