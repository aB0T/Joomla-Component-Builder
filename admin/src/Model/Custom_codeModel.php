 ...
 * @since  1.6
 */
class Custom_codeModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/custom_code.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/custom_code.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'custom_code', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('custom_code.delete', 'com_componentbuilder.custom_code.' . (int) $record->id);
	}
