 ...
 * @since  1.6
 */
class Joomla_plugin_files_folders_urlsModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/joomla_plugin_files_folders_urls.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/joomla_plugin_files_folders_urls.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'joomla_plugin_files_folders_urls', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('joomla_plugin_files_folders_urls.delete', 'com_componentbuilder.joomla_plugin_files_folders_urls.' . (int) $record->id);
	}
