 ...
 * @since  1.6
 */
class Joomla_plugin_groupModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/joomla_plugin_group.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/joomla_plugin_group.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'joomla_plugin_group', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('core.delete', 'com_componentbuilder.joomla_plugin_group.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_componentbuilder.edit.joomla_plugin_group.data', []);
