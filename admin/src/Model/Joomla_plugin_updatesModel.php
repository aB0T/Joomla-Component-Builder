 ...
 * @since  1.6
 */
class Joomla_plugin_updatesModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/joomla_plugin_updates.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/joomla_plugin_updates.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'joomla_plugin_updates', $prefix = 'Administrator', $config = [])
	{
	...
	public function getForm($data = [], $loadData = true, $options = ['control' => 'jform'])
	{
		...
		$form->setFieldAttribute('version_update', 'layout', ComponentbuilderHelper::getSubformLayout('joomla_plugin_updates', 'version_update'));
		return $form;
	}
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('joomla_plugin_updates.delete', 'com_componentbuilder.joomla_plugin_updates.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_componentbuilder.edit.joomla_plugin_updates.data', []);
