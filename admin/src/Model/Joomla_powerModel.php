 ...
 * @since  1.6
 */
class Joomla_powerModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/joomla_power.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/joomla_power.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'joomla_power', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('joomla_power.delete', 'com_componentbuilder.joomla_power.' . (int) $record->id);
	}
