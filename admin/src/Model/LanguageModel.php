...
class LanguageModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/language.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/language.js'
 	];
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('language.delete', 'com_componentbuilder.language.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_componentbuilder.edit.language.data', []);
