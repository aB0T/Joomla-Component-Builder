 ...
 * @since  1.6
 */
class Language_translationModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/language_translation.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/language_translation.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'language_translation', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('language_translation.delete', 'com_componentbuilder.language_translation.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_componentbuilder.edit.language_translation.data', []);
	...
	protected function batchCopy($values, $pks, $contexts)
	{
		...
		while (!empty($pks))
		{
			...
			// Only for strings
			if (UtilitiesStringHelper::check($this->table->source) && !is_numeric($this->table->source))
			{
