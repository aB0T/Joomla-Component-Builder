...
class LayoutModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/layout.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/layout.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'layout', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('core.delete', 'com_componentbuilder.layout.' . (int) $record->id);
	}
