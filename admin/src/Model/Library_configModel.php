 ...
 * @since  1.6
 */
class Library_configModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/library_config.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/library_config.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'library_config', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('library_config.delete', 'com_componentbuilder.library_config.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_componentbuilder.edit.library_config.data', []);
