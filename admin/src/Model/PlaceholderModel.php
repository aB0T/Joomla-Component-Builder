 ...
 * @since  1.6
 */
class PlaceholderModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/placeholder.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/placeholder.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'placeholder', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('placeholder.delete', 'com_componentbuilder.placeholder.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_componentbuilder.edit.placeholder.data', []);
	...
	protected function batchCopy($values, $pks, $contexts)
	{
		...
		while (!empty($pks))
		{
			...
			// Only for strings
			if (UtilitiesStringHelper::check($this->table->target) && !is_numeric($this->table->target))
			{
