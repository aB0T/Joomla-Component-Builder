...
class SnippetModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/snippet.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/snippet.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'snippet', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('core.delete', 'com_componentbuilder.snippet.' . (int) $record->id);
	}
