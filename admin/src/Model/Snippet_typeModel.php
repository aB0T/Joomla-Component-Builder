 ...
 * @since  1.6
 */
class Snippet_typeModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/snippet_type.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/snippet_type.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'snippet_type', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('snippet_type.delete', 'com_componentbuilder.snippet_type.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_componentbuilder.edit.snippet_type.data', []);
