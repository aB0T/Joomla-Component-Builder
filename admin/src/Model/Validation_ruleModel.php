 ...
 * @since  1.6
 */
class Validation_ruleModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_componentbuilder/assets/css/validation_rule.css'
 	];
	...
	protected array $scripts = [
		...
		'media/com_componentbuilder/js/validation_rule.js'
 	];
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'validation_rule', $prefix = 'Administrator', $config = [])
	{
	...
	protected function canDelete($record)
	{
		...
		return $this->getCurrentUser()->authorise('validation_rule.delete', 'com_componentbuilder.validation_rule.' . (int) $record->id);
	}
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_componentbuilder.edit.validation_rule.data', []);
