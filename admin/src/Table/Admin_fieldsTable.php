 ...
 * @since  1.6
 */
class Admin_fieldsTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.admin_fields';
		...
		parent::__construct('#__componentbuilder_admin_fields', 'id', $db, $dispatcher);
	}
