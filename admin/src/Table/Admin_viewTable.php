 ...
 * @since  1.6
 */
class Admin_viewTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.admin_view';
		...
		parent::__construct('#__componentbuilder_admin_view', 'id', $db, $dispatcher);
	}
