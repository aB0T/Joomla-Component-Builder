 ...
 * @since  1.6
 */
class Class_methodTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.class_method';
		...
		parent::__construct('#__componentbuilder_class_method', 'id', $db, $dispatcher);
	}
