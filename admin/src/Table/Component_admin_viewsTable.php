 ...
 * @since  1.6
 */
class Component_admin_viewsTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.component_admin_views';
		...
		parent::__construct('#__componentbuilder_component_admin_views', 'id', $db, $dispatcher);
	}
