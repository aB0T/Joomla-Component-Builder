 ...
 * @since  1.6
 */
class Component_configTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.component_config';
		...
		parent::__construct('#__componentbuilder_component_config', 'id', $db, $dispatcher);
	}
