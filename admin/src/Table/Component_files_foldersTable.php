 ...
 * @since  1.6
 */
class Component_files_foldersTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.component_files_folders';
		...
		parent::__construct('#__componentbuilder_component_files_folders', 'id', $db, $dispatcher);
	}
