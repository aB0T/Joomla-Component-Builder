 ...
 * @since  1.6
 */
class Component_modulesTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.component_modules';
		...
		parent::__construct('#__componentbuilder_component_modules', 'id', $db, $dispatcher);
	}
