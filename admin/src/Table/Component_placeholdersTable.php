 ...
 * @since  1.6
 */
class Component_placeholdersTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.component_placeholders';
		...
		parent::__construct('#__componentbuilder_component_placeholders', 'id', $db, $dispatcher);
	}
