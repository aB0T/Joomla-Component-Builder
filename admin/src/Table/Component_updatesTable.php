 ...
 * @since  1.6
 */
class Component_updatesTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.component_updates';
		...
		parent::__construct('#__componentbuilder_component_updates', 'id', $db, $dispatcher);
	}
