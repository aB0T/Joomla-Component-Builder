 ...
 * @since  1.6
 */
class Custom_admin_viewTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.custom_admin_view';
		...
		parent::__construct('#__componentbuilder_custom_admin_view', 'id', $db, $dispatcher);
	}
