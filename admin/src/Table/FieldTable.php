 ...
 * @since  1.6
 */
class FieldTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.field';
		...
		parent::__construct('#__componentbuilder_field', 'id', $db, $dispatcher);
	}
