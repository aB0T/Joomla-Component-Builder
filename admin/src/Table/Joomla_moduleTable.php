 ...
 * @since  1.6
 */
class Joomla_moduleTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.joomla_module';
		...
		parent::__construct('#__componentbuilder_joomla_module', 'id', $db, $dispatcher);
	}
