 ...
 * @since  1.6
 */
class Joomla_module_files_folders_urlsTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.joomla_module_files_folders_urls';
		...
		parent::__construct('#__componentbuilder_joomla_module_files_folders_urls', 'id', $db, $dispatcher);
	}
