 ...
 * @since  1.6
 */
class Joomla_pluginTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.joomla_plugin';
		...
		parent::__construct('#__componentbuilder_joomla_plugin', 'id', $db, $dispatcher);
	}
