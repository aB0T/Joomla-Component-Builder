 ...
 * @since  1.6
 */
class Joomla_plugin_groupTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.joomla_plugin_group';
		...
		parent::__construct('#__componentbuilder_joomla_plugin_group', 'id', $db, $dispatcher);
	}
