 ...
 * @since  1.6
 */
class Library_files_folders_urlsTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.library_files_folders_urls';
		...
		parent::__construct('#__componentbuilder_library_files_folders_urls', 'id', $db, $dispatcher);
	}
