 ...
 * @since  1.6
 */
class PowerTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.power';
		...
		parent::__construct('#__componentbuilder_power', 'id', $db, $dispatcher);
	}
