 ...
 * @since  1.6
 */
class Snippet_typeTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.snippet_type';
		...
		parent::__construct('#__componentbuilder_snippet_type', 'id', $db, $dispatcher);
	}
