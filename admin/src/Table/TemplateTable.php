 ...
 * @since  1.6
 */
class TemplateTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_componentbuilder.template';
		...
		parent::__construct('#__componentbuilder_template', 'id', $db, $dispatcher);
	}
