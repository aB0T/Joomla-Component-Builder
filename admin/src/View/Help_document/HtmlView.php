 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Help_document;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('help_document', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.help_document', $this->item->id);
				}
				if ($this->canDo->get('help_document.create'))
				{
