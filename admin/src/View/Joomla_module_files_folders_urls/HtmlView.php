 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Joomla_module_files_folders_urls;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('joomla_module_files_folders_urls', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				$canVersion = ($this->canDo->get('core.version') && $this->canDo->get('joomla_module_files_folders_urls.version'));
				if ($this->state->params->get('save_history', 1) && $this->canDo->get('joomla_module_files_folders_urls.edit') && $canVersion)
				{
					ToolbarHelper::versions('com_componentbuilder.joomla_module_files_folders_urls', $this->item->id);
				}
				if ($this->canDo->get('joomla_module_files_folders_urls.create'))
				{
					ToolbarHelper::custom('joomla_module_files_folders_urls.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('joomla_module_files_folders_urls.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('joomla_module_files_folders_urls');
