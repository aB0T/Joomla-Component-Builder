 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Joomla_module_updates;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('joomla_module_updates', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				$canVersion = ($this->canDo->get('core.version') && $this->canDo->get('joomla_module_updates.version'));
				if ($this->state->params->get('save_history', 1) && $this->canDo->get('joomla_module_updates.edit') && $canVersion)
				{
					ToolbarHelper::versions('com_componentbuilder.joomla_module_updates', $this->item->id);
				}
				if ($this->canDo->get('joomla_module_updates.create'))
				{
					ToolbarHelper::custom('joomla_module_updates.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('joomla_module_updates.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('joomla_module_updates');
