 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Joomla_plugin_files_folders_urls;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('joomla_plugin_files_folders_urls', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.joomla_plugin_files_folders_urls', $this->item->id);
				}
				if ($this->canDo->get('joomla_plugin_files_folders_urls.create'))
				{
					ToolbarHelper::custom('joomla_plugin_files_folders_urls.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('joomla_plugin_files_folders_urls.cancel', 'JTOOLBAR_CLOSE');
			}
		}
