 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Language;
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.language', $this->item->id);
				}
				if ($this->canDo->get('language.create'))
				{
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('language');
