 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Library;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('library', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.library', $this->item->id);
				}
				if ($this->canDo->get('library.create'))
				{
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('library');
