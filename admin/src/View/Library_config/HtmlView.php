 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Library_config;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('library_config', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.library_config', $this->item->id);
				}
				if ($this->canDo->get('library_config.create'))
				{
					ToolbarHelper::custom('library_config.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('library_config.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('library_config');
