 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Snippet_type;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('snippet_type', $this->item);
	...
	protected function addToolbar(): void
	{
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_componentbuilder.snippet_type', $this->item->id);
				}
				if ($this->canDo->get('snippet_type.create'))
				{
					ToolbarHelper::custom('snippet_type.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				ToolbarHelper::cancel('snippet_type.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		...
		$this->help_url = ComponentbuilderHelper::getHelpUrl('snippet_type');
