 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Snippets;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		if (!$this->isEmptyState)
		{
			...
			if ($this->canEdit)
			{
				$childBar->edit('snippet.edit')->listCheck(true);
			}
			...
			if ($this->canState)
			{
				...
				{
					$toolbar->delete('snippets.delete', 'JTOOLBAR_DELETE_FROM_TRASH')
