 ...
 */
namespace VDM\Component\Componentbuilder\Administrator\View\Templates;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => Text::_('COM_COMPONENTBUILDER_TEMPLATE_NAME_LABEL'),
			'a.description' => Text::_('COM_COMPONENTBUILDER_TEMPLATE_DESCRIPTION_LABEL'),
			'g.name' => Text::_('COM_COMPONENTBUILDER_TEMPLATE_DYNAMIC_GET_LABEL'),
