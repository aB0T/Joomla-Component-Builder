...
<div class="row">
	...
	<?php echo Html::_('uitab.startTabSet', 'layoutTab', ['active' => 'details', 'recall' => true]); ?>

	<?php echo Html::_('uitab.addTab', 'layoutTab', 'details', Text::_('COM_COMPONENTBUILDER_LAYOUT_DETAILS', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'layoutTab', 'custom_script', Text::_('COM_COMPONENTBUILDER_LAYOUT_CUSTOM_SCRIPT', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'layoutTab', 'publishing', Text::_('COM_COMPONENTBUILDER_LAYOUT_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'layoutTab', 'permissions', Text::_('COM_COMPONENTBUILDER_LAYOUT_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
				<fieldset id="fieldset-rules" class="options-form">
					<legend><?php echo Text::_('COM_COMPONENTBUILDER_LAYOUT_PERMISSION'); ?></legend>
					<div>
